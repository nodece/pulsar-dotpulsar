...
namespace DotPulsar.Internal
{
    ...
    public sealed class MessageFactory<TValue> : IMessageFactory<TValue>
    {
        ...
        public IMessage<TValue> Create(string topic, MessageId messageId, uint redeliveryCount, ReadOnlySequence<byte> data, MessageMetadata metadata, SingleMessageMetadata?
            singleMetadata = null)
        {
