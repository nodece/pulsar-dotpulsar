...
namespace DotPulsar.Abstractions
{
    ...
    {
        /// <summary>
        /// Acknowledge the consumption of a single message using the Message.
        /// </summary>
        ValueTask Acknowledge(IMessage message, CancellationToken cancellationToken = default);

        /// <summary>
        /// Acknowledge the consumption of all the messages in the topic up to and including the provided Message.
        /// </summary>
        ValueTask AcknowledgeCumulative(IMessage message, CancellationToken cancellationToken = default);
        ...
        /// </summary>
        ValueTask RedeliverUnacknowledgedMessages(IEnumerable<IMessage> messages, CancellationToken cancellationToken = default);
